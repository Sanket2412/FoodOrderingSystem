<html>
<head>
    <title> Guest Signup | FRIENDS CORNER CAFE</title>
  </head>
...
?>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Guest, <br> Welcome to <span class="edit">FRIENDS CORNER CAFE</span></h1>
     <br>
      ...
      <div class="panel panel-primary">
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control" id="cust_username" type="text" name="cust_username" onkeypress="checkspace(event)" onfocusout="user()" placeholder="Your Username " required="">
              <span class="input-group-btn">
                <label class="btn btn-primary"><span class="glyphicon glyphicon-user" aria-hidden="true"></label>
            </span>
              </span>
...
<div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control" id="cust_address" type="text" name="cust_address" placeholder=" Full Address"onfocusout="add()" required="">
              <span class="input-group-btn">
 ...
 <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control" id="cust_phoneno" type="text" name="cust_phoneno" onkeypress="check(event)" onfocusout="return mob()"placeholder="Contact" required="">
              <span class="input-group-btn">
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control" id="cust_password" type="password" name="cust_password" onkeypress="checkspace(event)" onfocusout="password()" placeholder="Password" required="">
              <span class="input-group-btn">
