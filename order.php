...
<div class="jumbotron">
  <div class="container text-center">
    ...
    <!--p>Let FOOD be solution to all PROBLEMS</p-->
  </div>
</div>
  ...
  while($row = mysqli_fetch_array($result))
	{
    		if ($count == 0)
      		echo "<div class='row'>";
		$sql1="SELECT DISTINCT(order_id),f_name,quantity,amt from order_details,food WHERE food.f_id=order_details.f_id AND order_id='".$row["order_id"]."';";
